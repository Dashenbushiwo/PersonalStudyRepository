...
<html>
	...
	<title>员工列表</title>
	<link rel="stylesheet" href="${APP_PATH}/static/bootstrap-4.6.2-dist/css/bootstrap.min.css">
	<script type="" src="${APP_PATH }/static/jquery-3.7.0.min.js"></script>
	<script type="javascript" src="${APP_PATH }/static/bootstrap-4.6.2-dist/js/bootstrap.bundle.min.js"></script>
</head>
<body>
<!-- 员工修改的模态框 -->
...
<div class="modal fade" id="empAddModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
	...
	<script type="text/javascript">
		...
		function to_page(pn){
			$.ajax({
				url:"${APP_PATH}/employee/pageJson",
				data:"pageNum="+pn,
				type:"GET",
				success:function(result){
					//1、解析并显示员工数据
					build_emps_table(result.data.list);
					//2、解析并显示分页信息
		...
		function build_emps_table(dataList){
			//清空table表格
			...
			$.each(dataList,function(index,item){
				...
				const genderTd = $("<td></td>").append(item.gender==='M'?"男":"女");
